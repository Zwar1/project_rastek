...
//    @DeleteMapping(
//            path = "/api/deleteLastEmployee",
//            produces = MediaType.APPLICATION_JSON_VALUE
//    )
////    public web_response<String> deleteLastEmployee() {
////        employeeService.deleteLastEmployee();
////        return web_response.<String>builder().data("Last employee deleted successfully").build();
////    }
}
