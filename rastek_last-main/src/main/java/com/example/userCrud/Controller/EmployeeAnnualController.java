...
public class EmployeeAnnualController {
    ...
    @PutMapping("/api/employeeAnnual/employee/{employeeId}/annual-leaves")
    public ResponseEntity<EmployeeAnnualListRes> updateEmployeeAnnualList(
            @PathVariable long employeeId,
            @RequestBody EmployeeAnnualListReq updateRequest) {
        EmployeeAnnualListRes response = employeeAnnualService.updateEmployeeAnnualList(employeeId, updateRequest);
